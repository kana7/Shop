    ...
    f.prototype.toggle = function (d) {
        ...
        if (/(38|40|27)/.test(b.keyCode)) {
            ...
            if (b.preventDefault(), b.stopPropagation(), !d.is(".disabled, :disabled")) {
                ...
                if (!g || g && 27 == b.keyCode)
                    return 27 == b.which && f.find(e).trigger("focus"), d.trigger("click");
    ...
    b.DEFAULTS = {toggle: !0}, b.prototype.dimension = function () {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                var f = function (b) {
                    return b && b.target != this.$element[0] ? void this.$element.one(a.support.transition.end, a.proxy(f, this)) : (this.$element.removeClass("collapsing").addClass("collapse in")[e](""), this.transitioning = 0, void this.$element.trigger("shown.bs.collapse"))
                };
